...
import { reducirEventos, sonEstadosIguales, ejercicioMarcadoSchema, ejercicioDesmarcadoSchema, registroDiarioSchema, faseChangiadaSchema, } from './eventos';
function crearEjercicioMarcado(fecha, ejercicio_id, timestamp) {
...
function crearRegistroDiario(fecha, valores, timestamp) {
...
function crearFaseCambiada(fase_nueva, timestamp) {
