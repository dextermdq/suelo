...
import { calcularPromedioMovil, calcularTendencia, calcularTendenciasSemanal, } from './tendencias';
...
describe('tendencias', () => {
    describe('promedio móvil', () => {
        it('calcula promedio 7 días correctamente', () => {
            ...
            const promedio = calcularPromedioMovil(estado, 'tension_basal', '2026-09-18', 7);
        ...
        it('promedio 28 días requiere 50% de datos', () => {
            ...
            const estado = reducirEventos(eventos);
            const promedio = calcularPromedioMovil(estado, 'tension_basal', '2026-09-18', 28);
    ...
    describe('tendencias semanales', () => {
        it('calcula tendencias para una variable', () => {
            ...
            const estado = reducirEventos(eventos);
            const tendencias = calcularTendenciasSemanal(estado, 'tension_basal', '2026-09-18');
