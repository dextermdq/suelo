...
import { numeroSemanaISO, anoSemanaISO, lunesDelaSemana, domingoDelaSemana, diasDeLaSemana, estEnSemana, rangoSemana, fechaADate, dateAFecha, } from './semana';
describe('semana', () => {
    ...
    describe('lunes y domingo de una semana', () => {
        ...
        it('lunes de lunes retorna el mismo lunes', () => {
            ...
            const diff = Math.abs((new Date(lunesDate).getTime() - new Date(resultado).getTime()) /
                (24 * 60 * 60 * 1000));
    ...
    describe('días de una semana', () => {
        ...
        it('rango de 7 días es consistente', () => {
            ...
            const diff = Math.abs((d2.getTime() - d1.getTime()) / (24 * 60 * 60 * 1000));
            expect(diff).toBe(6);
        });
    });
    describe('verificar si está en semana', () => {
        it('misma semana retorna true', () => {
            const fecha = '2026-09-18';
            expect(estEnSemana(fecha, numeroSemanaISO(fecha), anoSemanaISO(fecha))).toBe(true);
        });
