...
export function numeroSemanaISO(fecha) {
    ...
    thursdayOfWeek.setUTCDate(thursdayOfWeek.getUTCDate() - date.getUTCDay() + 4);
...
export function anoSemanaISO(fecha) {
    const date = fechaADate(fecha);
    const thursdayOfWeek = new Date(date);
    thursdayOfWeek.setUTCDate(thursdayOfWeek.getUTCDate() - date.getUTCDay() + 4);
...
export function diasDeLaSemana(fecha) {
...
export function estEnSemana(fecha, numeroSemana, anoSemana) {
 ...
 */
export function rangoSemana(fecha) {
