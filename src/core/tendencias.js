 ...
 */
export function calcularPromedioMovil(estado, variable, fecha, dias) {
...
export function calcularTendencia(promedio7, promedio28) {
    if (!promedio7 && !promedio28)
        return 'sin_datos';
    if (!promedio7 || !promedio28)
        return 'sin_datos';
...
export function calcularTendenciasSemanal(estado, variable, fecha) {
...
export function calcularTendenciasSemanales(estado, variables, fecha) {
